...
class Entity : public Describable, public sf::Drawable {
    public:
        ...
        void addVisit() {++mNumberOfVisits;}
        //getters
        const std::string& getFaction() const {return mFaction;}
        const Status& getStatus() const {return mStatus;}
        double getStat(const std::string& statName) const {return mStatus.get(statName);}
        ...
        unsigned int getNumberOfVisits() const {return mNumberOfVisits;}
        //checkers
    ...
    private:
        ...
        //number of times the entity has been talked to
        unsigned int mNumberOfVisits = 0;
        ///AI
        //entity's brain
